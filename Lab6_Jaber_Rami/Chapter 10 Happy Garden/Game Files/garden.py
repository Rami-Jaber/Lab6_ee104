...
raining = randint(0, 1) #randomizes rain outcome
cow = Actor("cow")
cow.pos = 100, 500
flower_list = []
wilted_list = []
...
def add_flowers():
    ...
    if not game_over:
        new_flower()
        clock.schedule(add_flowers, 2) #increased flowers thus increasing enemy spawn
    return
   # pass
...
def mutate():
    ...
    if not game_over and flower_list:
        ...
        clock.schedule(mutate, 10) #increased flangflowers spawn rate
    return
    #pass
